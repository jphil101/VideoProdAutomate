...
def get_script_and_segments(old_script_text, old_segments_data):
    ...
    2. If a new sentence contains 2+ distinct clauses (e.g., joined by "and", "but"), you SHOULD split it into separate segments if they represent different visual ideas.
    3. A new segment should ideally not exceed ~15-20 words.
    4. The TOTAL number of segments must be AT LEAST {min_segments}.
    ...
    5. GOOD examples: "mixing plaster", "cracked drywall", "cement truck", "drywall application"
    6. BAD examples (too vague/ambiguous): "water", "cracked joints", "clock", "application"
